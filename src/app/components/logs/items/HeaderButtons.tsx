...
import CreateLogModal from '../create/Modal';
    ...
    <div className="flex gap-4">
      ...
      {selectedItems.size > 0 && (
        <button
          ...
          className="bg-red-500 text-white px-4 py-2 cursor-pointer rounded-lg flex items-center gap-2 hover:bg-red-600 transform"
        >
