...
import CreateUserModal from '@/app/components/users/create/Modal';
...
const HeaderButtons: FC<IHeaderButtons> = ({
  ...
  return (
    <div className="flex gap-4">
      ...
      <button className="bg-blue-500 text-white cursor-pointer px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-600">
